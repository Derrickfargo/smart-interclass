...
public class Application {
	...
	public void clear() {
		...
		clientChannel = new HashMap<String, ChannelHandlerContext>();
		groupChannel = new HashMap<Integer, List<ChannelHandlerContext>>();
	}
	...
	public void addLoginStudent(String imei, Student student) {
		...
		for (Student aStudent : studentList) {
			if (aStudent.getName().equals(student.getName()) && aStudent.getNumber().equals(student.getNumber())) {
				isLogin = true;
				break;
			}
		}
		...
		for (Map.Entry<String, List<Student>> entry : imeiStudent.entrySet()) {
			for (Student student : entry.getValue()) {
				for (Student stu : students) {
					if (stu.getName().equals(student.getName()) && stu.getNumber().equals(student.getNumber())) {
	...
	public Map<String, ChannelHandlerContext> getClientChannel() {
	 ...
	 * @param tables
	 */
	public void initMapping(List<Device> devices, List<Table> tables, List<Group> groups) {
	...
	public List<ChannelHandlerContext> getClientChannelByGroup(Integer groupId) {
		List<ChannelHandlerContext> channels = groupChannel.get(groupId);
		List<ChannelHandlerContext> retval = new ArrayList<ChannelHandlerContext>();
		if (channels != null) {
