...
public class GroupPanel1 extends JPanel implements MouseListener{
	private static final long serialVersionUID = 3263791015780289798L;
	private static final String ICO_OPTION_CHECKED = "images/group/ico_checked.png";
	private static final String ICO_OPTION_UNCHECKED = "images/group/ico_unchecked.png";
	private static final String ICO_NEXT = "images/group/btn_next1.png";
	...
	private void initView(){
		JLabel lblTitle = new JLabel("学生分组");
		lblTitle.setBounds(10, 20, 500, 25);
		...
		JLabel lblOption1 = new JLabel("  位置这样就好",JLabel.LEFT);
...
//		lblOption1.setForeground(new Color(Integer.parseInt("efefef", 16)));
		lblOption1.setBounds(30, 65, 800, 35);
		add(lblOption1);
...
//		lblOption2.setForeground(new Color(Integer.parseInt("efefef", 16)));
		add(lblOption2);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getSource() == btnNext) {
			...
			case 2:
				//随机分组
				MainFrame.getInstance().doRdmGroup();
				break;
			}
		}
	}
...
//		if(e.getSource()==btnNext){
//			btnNext.setIcon(new ImageIcon("images/responder/responder_hover.png"));
//		}
	}
...
//		if(e.getSource()==btnNext){
//			btnNext.setIcon(new ImageIcon("images/responder/responder.png"));
//		}
	}
}
