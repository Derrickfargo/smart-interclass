									...
									<div class="col-xs-12">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<label class="col-xs-2 control-label"><span class="span-red-bold">* </span>课时数：</label>
												<div class="col-xs-4">
													<input type="text" name="sum" id="sum" value="${course.sum}" maxlength="3" class="form-control borderRadiusIE8 required"  onkeyup="$('#checkSumTip').addClass('hidden')">
													<p id="checkSumTip" class="help-block hidden"><font color="red"><b>请输入正确的课时数</b></font></p>
												</div>
											</div>
											<div class="form-group">
