...
//		}
	...
	public class MyPagerAdapter extends PagerAdapter {
		...
		private ArrayList<EvaluateVo> paperList;
...
//			}
			if(!quizList.get(mCurrentViewID).isFirstShow){
				initEvaluateBtn();
			}
			quizList.get(mCurrentViewID).setFirstShow(false);//设置当前页面不是最后第一次显示
