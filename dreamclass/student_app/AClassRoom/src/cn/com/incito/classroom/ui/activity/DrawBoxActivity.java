...
public class DrawBoxActivity extends BaseActivity implements OnClickListener, ISketchPadCallback {
	...
	public void onClick(View v) {
		if (v.getId() != R.id.bg_select_btn && v.getId() != R.id.big && v.getId() != R.id.middle && v.getId() != R.id.small) {// 选择笔的粗细时
			// 跳出的笔不缩回
		...
		case R.id.color_white:
			...
			m_sketchPad.setStrokeColor(getResources().getColor(android.R.color.white));
			break;
		case R.id.color_canary_yellow:
			Translate(color_canary_yellow, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.canary_yellow));
			break;
		case R.id.ico_lemon_yellow:
			Translate(ico_lemon_yellow, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.lemon_yellow));
			break;
		case R.id.ico_salmon_orange:
			Translate(ico_salmon_orange, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.salmon_orange));
			break;
		case R.id.ico_spanish_orange:
			Translate(ico_spanish_orange, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.spanish_orange));
			break;
		case R.id.ico_mineral_orange:
			Translate(mMineralOrange, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.mineral_orange));
			break;
		case R.id.ico_carmine_red:
			Translate(mCarmineRed, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.carmine_red));
			break;
		case R.id.ico_hot_ink:
			Translate(mHotInk, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.hot_ink));
			break;
		case R.id.ico_magenta:
			Translate(mMagenta, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.magenta));
			break;
		case R.id.ico_powder_blue:
			Translate(ico_powder_blue, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.powder_blue));
			break;
		case R.id.ico_turquoise:
			Translate(ico_turquoise, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.turquoise));
			break;
		case R.id.ico_peacpck_blue:
			Translate(ico_peacpck_blue, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.peacpck_blue));
			break;
		case R.id.ico_dark_purple:
			Translate(ico_dark_purple, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.dark_purple));
			break;
		case R.id.ico_dark_green:
			Translate(mDarkGreen, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.dark_green));
			break;
		case R.id.ico_moss_green:
			Translate(mMossGreen, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.moss_green));
			break;
		case R.id.ico_parrot_green:
			Translate(mParrotGreen, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.parrot_green));
			break;
		case R.id.ico_chocolate:
			Translate(mChocolate, -0.25f);
			m_sketchPad.setStrokeType(SketchPadView.STROKE_PEN);
			m_sketchPad.setStrokeColor(getResources().getColor(R.color.chocolate));
			break;
		case R.id.ico_black:
