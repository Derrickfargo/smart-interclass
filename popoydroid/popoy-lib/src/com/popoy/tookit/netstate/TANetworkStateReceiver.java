 ...
 */
package com.popoy.tookit.netstate;
...
public class TANetworkStateReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		{
			Logger.i(TANetworkStateReceiver.this, "网络状态改变.");
			if (!TANetWorkUtil.isNetworkAvailable(context))
			{
				Logger.i(TANetworkStateReceiver.this, "没有网络连接.");
				networkAvailable = false;
			} else
			{
				Logger.i(TANetworkStateReceiver.this, "网络连接成功.");
