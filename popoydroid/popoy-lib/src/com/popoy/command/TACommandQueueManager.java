...
public final class TACommandQueueManager
{
	...
	{
		Logger.i(TACommandQueueManager.this, "准备初始化！");
		if (!initialized)
		{
			Logger.i(TACommandQueueManager.this, "正在初始化！");
			queue = new TACommandQueue();
			pool = TAThreadPool.getInstance();
			Logger.i(TACommandQueueManager.this, "完成初始化！");

			pool.start();
			initialized = true;
		}
		Logger.i(TACommandQueueManager.this, "初始化完成！");
	}
	...
	{
		Logger.i(TACommandQueueManager.this, "获取Command！");
		TAICommand cmd = queue.getNextCommand();
		Logger.i(TACommandQueueManager.this, "获取Command" + cmd + "完成！");
		return cmd;
	}
	...
	{
		Logger.i(TACommandQueueManager.this, "添加" + cmd + "开始");
		queue.enqueue(cmd);
		Logger.i(TACommandQueueManager.this, "添加" + cmd + "完成");
	}
