 ...
 */
package com.popoy.widget.sliding;

import java.util.ArrayList;
import java.util.List;

import com.popoy.tookit.utils.FileUtils;
import com.popoy.widget.listener.AbOnChangeListener;
import com.popoy.widget.listener.AbOnItemClickListener;
import com.popoy.widget.listener.AbOnScrollListener;
import com.popoy.widget.listener.AbOnTouchListener;
...
public class AbSlidingPlayView extends LinearLayout {
	...
	public void initView(Context context){
		...
		displayImage = FileUtils.getBitmapFormSrc("image/play_display.png");
		hideImage = FileUtils.getBitmapFormSrc("image/play_hide.png");
