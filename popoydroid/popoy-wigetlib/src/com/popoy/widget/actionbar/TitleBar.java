...
package com.popoy.widget.actionbar;

import java.util.LinkedList;

import com.popoy.common.R;
...
public class TitleBar extends RelativeLayout implements OnClickListener {
	...
	private void initTitleBar(Context context, AttributeSet attrs) {
		...
		CharSequence title = a.getString(R.styleable.TitleBar_title);
		if (title != null) {
			setTitle(title);
		}
		a.recycle();
	...
	private View inflateAction(Action action) {
		View view = mInflater.inflate(R.layout.titlebar_item, mActionsView,
				false);
	...
	public static class IntentAction extends AbstractAction {
		...
		public void performAction(View view) {
			try {
				if (mIntent == null && mContext instanceof TAActivity) {
					((TAActivity) mContext).back();
				} else {
	...
	public static class CustomAction extends AbstractAction {
		...
		public CustomAction(Context context, DoAction doAction, int drawable) {
			super(drawable);
