 ...
 */
public class AbMultiColumnHeaderViewListAdapter implements WrapperListAdapter, Filterable {
    ...
    static final ArrayList<AbMultiColumnAbsListView.FixedViewInfo> EMPTY_INFO_LIST =
    ...
    public AbMultiColumnHeaderViewListAdapter(ArrayList<AbMultiColumnAbsListView.FixedViewInfo> headerViewInfos,
    ...
    public boolean removeHeader(View v) {
        for (int i = 0; i < mHeaderViewInfos.size(); i++) {
            AbMultiColumnAbsListView.FixedViewInfo info = mHeaderViewInfos.get(i);
            if (info.view == v) {
    ...
    public boolean removeFooter(View v) {
        for (int i = 0; i < mFooterViewInfos.size(); i++) {
            AbMultiColumnAbsListView.FixedViewInfo info = mFooterViewInfos.get(i);
            if (info.view == v) {
    ...
    public int getItemViewType(int position) {
        ...
        return AbMultiColumnAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER;
    }
