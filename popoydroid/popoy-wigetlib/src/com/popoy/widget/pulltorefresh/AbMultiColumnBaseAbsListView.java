 ...
 * 
 */
public abstract class AbMultiColumnBaseAbsListView extends AbMultiColumnAdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
     ...
     * Acts upon click
     */
    private AbMultiColumnBaseAbsListView.PerformClick mPerformClick;
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(AbMultiColumnBaseAbsListView.this, originalView, longPressPosition, longPressId);
            }
            if (!handled) {
        ...
        case MotionEvent.ACTION_UP: {
            ...
            case TOUCH_MODE_DONE_WAITING:
                ...
                if (child != null && !child.hasFocusable()) {
                    ...
                    final AbMultiColumnBaseAbsListView.PerformClick performClick = mPerformClick;
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new AbMultiColumnBaseAbsListView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof AbMultiColumnBaseAbsListView.LayoutParams;
    }
    ...
    public void reclaimViews(List<View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            AbMultiColumnBaseAbsListView.LayoutParams lp = (AbMultiColumnBaseAbsListView.LayoutParams) child.getLayoutParams();
     ...
     *            recycler.
     * 
     * @see android.widget.AbMultiColumnBaseAbsListView.RecycleBin
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap) {
            AbMultiColumnBaseAbsListView.LayoutParams lp = (AbMultiColumnBaseAbsListView.LayoutParams) scrap.getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    int whichScrap = ((AbMultiColumnBaseAbsListView.LayoutParams) victim.getLayoutParams()).viewType;
