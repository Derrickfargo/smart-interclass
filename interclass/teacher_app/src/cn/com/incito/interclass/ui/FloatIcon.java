...
public class FloatIcon extends MouseAdapter {
	...
	private static final int DOUBLE_MENU_HEIGHT = 242;
	...
	private JPanel createMenu(){
		...
		btnExit.setBounds(/*114, 174,*/114, 17, iconExit.getIconWidth(),
	...
	private void showMenu(boolean isShowing) {
		...
		case LEFT_TOP:
			lblBackground.setBounds(0, 0, 220, 121);
			break;
		case LEFT_BOTTOM:
			lblBackground.setBounds(0, 121, 220, 121);
			break;
		case RIGHT_TOP:
			lblBackground.setBounds(220, 0, 220, 121);
			break;
		case RIGHT_BOTTOM:
			lblBackground.setBounds(220, 121, 220, 121);
			break;
		}
