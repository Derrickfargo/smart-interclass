									...
									<div class="col-xs-12">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input type="text" name="name" id="schoolName" value="${school.name}" maxlength="40" class="form-control borderRadiusIE8 required" autocomplete="off" onkeyup="$('#checkSchoolNameTip').addClass('hidden')">
													<p id="checkSchoolNameTip" class="help-block hidden"><font color="red"><b>请输入学校名称（2~20汉字）</b></font></p>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input type="text" id="address" name="address" maxlength="30" value="${school.address}" class="form-control borderRadiusIE8 required" onkeyup="$('#checkAddressTip').addClass('hidden')">
