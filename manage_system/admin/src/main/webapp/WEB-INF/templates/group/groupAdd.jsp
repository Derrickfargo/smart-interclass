			...
			<div class="col-xs-12 col-sm-10">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">新增组</h3>
					</div>
					<div class="panel-body">
						<div class="col-xs-12" style="height:10px;"></div>
						<div class="tab-content">
							<div class="tab-pane active" id="groupinfo">
								<form action="${path}/group/save" id="groupForm" method="post" class="form-horizontal">
									<div class="col-xs-12">
										<div class="col-xs-12">
											<div class="form-group">
												<label class="col-xs-2 control-label"><span class="span-red-bold">* </span>学校名称：</label>
												<div class="col-xs-4">
													<input type="text" name="name" id="groupName" value="${group.name}" maxlength="128" class="form-control borderRadiusIE8 required"  onkeyup="$('#checkSchoolNameTip').addClass('hidden')">
												...
												<div class="col-xs-4">
													<input type="text" name="zipCode" id="zipCode" value="${group.zipCode}" maxlength="8" class="form-control borderRadiusIE8 required"  onkeyup="$('#checkZipCodeTip').addClass('hidden')">
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input type="text" id="email" name="email" maxlength="18" value="${group.email}" class="form-control borderRadiusIE8 required"  onkeyup="$('#checkEmailTip').addClass('hidden')">
												...
												<div class="col-xs-4">
													<input type="text" name="phone" id="phone" value="${group.phone}" maxlength="12" class="form-control borderRadiusIE8 required"  onkeyup="$('#checkPhoneTip').addClass('hidden')">
											...
											<div class="form-group">
												...
												<div class="col-xs-4">
													<input type="text" id="address" name="address" value="${group.groupName}" class="form-control borderRadiusIE8 required" onkeyup="$('#checkAddressTip').addClass('hidden')">
