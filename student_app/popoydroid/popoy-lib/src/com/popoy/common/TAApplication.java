...
import com.popoy.controller.ActivityStackInfo;
import com.popoy.controller.NavigationDirection;
import com.popoy.exception.AppException;
import com.popoy.exception.TANoSuchCommandException;
import com.popoy.mvc.common.TAIResponseListener;
...
import com.popoy.tookit.resoperate.TAPropertiesConfig;
import com.popoy.tookit.utils.Logger;
import com.popoy.tookit.utils.TAInjector;
...
//    private TASQLiteDatabasePool mSQLiteDatabasePool;
    ...
    public void doCommand(String commandKey, TARequest request,
        ...
        if (listener != null) {
            ...
            Logger.i(TAApplication.this, "go with cmdid=" + commandKey
            ...
            Logger.i(TAApplication.this, "Enqueue-ing command");
            try {
                TACommandExecutor.getInstance().enqueueCommand(commandKey,
                        request, this);
            } catch (TANoSuchCommandException e) {
            ...
            Logger.i(TAApplication.this, "Enqueued command");
