...
import com.popoy.tookit.utils.AbGraphical;
...
public class AbWheelView extends View {
	...
	public void setValueTextSize(int textSize) {
		this.valueTextSize = ViewUtil.resizeTextSize(screenWidth,screenHeight, textSize);
	...
	public void setLabelTextSize(int labelTextSize) {
		this.labelTextSize = ViewUtil.resizeTextSize(screenWidth,screenHeight, labelTextSize);
	}
