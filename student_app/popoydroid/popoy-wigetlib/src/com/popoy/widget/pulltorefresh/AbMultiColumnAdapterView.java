...
public abstract class AbMultiColumnAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public AbMultiColumnAdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AbMultiColumnAdapterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(AbMultiColumnAdapterView<?> parent, View view, int position, long id);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (AbMultiColumnAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0 && mItemCount > 0) {
                AbMultiColumnAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (AbMultiColumnAdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting
                // activity is being
                // stopped and later restarted
                mInstanceState = AbMultiColumnAdapterView.this.onSaveInstanceState();
            }
